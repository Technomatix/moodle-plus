...
sed -i "s/base_url:\s*'http:\/\/[0-9\.\?]\+:8000/base_url: 'http:\/\/$builtin:8000/" moodledata/behat/behat/behat.yml
sed -i "s/wd_host:\s*'http:\/\/localhost:4444/wd_host: 'http:\/\/$selenium:4444/" moodledata/behat/behat/behat.yml
